...
import { EntityIFace } from '../interface/EntityIFace';
import { Response } from '../../ngrx/service/Response';
export abstract class BaseService<REQ, RES, T extends EntityIFace> {
